					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr class = "text-center">
								...
								<td><fmt:formatNumber value="<%=invest.getInvest_sum()%>" type="currency" currencySymbol="￦"></fmt:formatNumber></td>
								<td><%=invest.getGoodsVO().getGoods_num()%></td>
								<td><fmt:formatNumber value="<%=invest.getInvest_return()%>" type="currency" currencySymbol="￦"></fmt:formatNumber></td>
								<td><%=invest_status%></td>
							</tr>
							<%
							} 
