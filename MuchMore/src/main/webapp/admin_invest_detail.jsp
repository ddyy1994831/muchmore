 				...
 				<thead>
  				...
  				%>
  					<tr>
      					...
      					<td><fmt:formatNumber value="<%=invest.getInvest_sum() %>" type="currency" currencySymbol="￦" /></td>
      					<td><%=invest.getGoodsVO().getGoods_rate() %>%</td>
      					<td><fmt:formatNumber value="<%=invest.getInvest_return() %>" type="currency" currencySymbol="￦" /></td>
      					<%
